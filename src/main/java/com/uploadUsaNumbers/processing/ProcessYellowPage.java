...
public class ProcessYellowPage {
    ...
    private static void processYellowPages(String path) {
        ...
        for (File file : listOfFiles) {
            if (file.isFile()) {
                ...
                Thread thread_phone_name = new Thread(() -> {
                    Utils.writeToCSVYellowPagesPhoneNames(YellowPageExportToPhoneName + phone_names, PhoneNamesList);
                });
                ...
                Thread thread_phone_email = new Thread(() -> {
                    Utils.writeToCSVYellowPagesPhoneEmails(YellowPageExportToPhoneEmail + phone_emails, PhoneEmailList);
                });
        ...
        System.out.println("countAllNumbers: " + Utils.count);
