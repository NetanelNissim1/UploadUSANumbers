...
public static void createZipfilesUSANumbers(){
    ...
    Thread thread_ZIP_Phone_Name = new Thread(() -> {
        try {
            Utils.preZipFile( App.UploadUSANumbersExportZip, App.UploadUSANumbersExportToPhoneNamesZip, "PhoneNames.zip");
    ...
    Thread thread_ZIP_Phone_Emails = new Thread(() -> {
        try {
            Utils.preZipFile( App.UploadUSANumbersExportZip, App.UploadUSANumbersExportToPhoneEmailsZip, "PhoneEmails.zip");
        } catch (IOException ex) {
            Logger.getLogger(ZipFiles.class.getName()).log(Level.SEVERE, null, ex);
        }
    });
    ...
    Thread thread_ZIP_mobile_Phone_Name = new Thread(() -> {
        try {
            Utils.preZipFile( App.UploadUSANumbersExportZip, App.UploadUSANumbersExportToMobilePhoneNamesZip, "MobilePhoneNames.zip");
        } catch (IOException ex) {
            Logger.getLogger(ZipFiles.class.getName()).log(Level.SEVERE, null, ex);
        }
    });
    ...
    Thread thread_ZIP_mobile_Phone_Emails = new Thread(() -> {
        try {
            Utils.preZipFile( App.UploadUSANumbersExportZip, App.UploadUSANumbersExportToMobilePhoneEmailsZip, "MobilePhoneEmails.zip");
        } catch (IOException ex) {
            Logger.getLogger(ZipFiles.class.getName()).log(Level.SEVERE, null, ex);
        }
    });
